...
<div class="container py-5">
 ...
 @endif
   ...
   <!-- Start Panel -->
    ...
    <hr>
<iframe src="https://www.free-kassa.ru/merchant/forms.php?gen_form=1&writer=seller&targets={{ $response->id }}&default-sum=5&button-text=Donate&hint=&type=big&m=222263&id=1241961"  width="100%" height="auto" frameBorder="0" target="_parent" ></iframe>
</div><!-- /COL MD -->
