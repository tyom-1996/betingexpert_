        	...
        	<div class="box box-danger">
                ...
                <form class="form-horizontal" method="POST" action="{{ url('panel/admin/campaigns/edit/'.$data->id) }}" enctype="multipart/form-data">
                 ...
                 <!-- Start Box Body -->
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-2 control-label">{{ trans('misc.campaign_funds') }}</label>
                      <div class="col-sm-10">
                        <input type="number" min="1" autocomplete="off" value="{{ $data->funds }}" name="funds" class="form-control onlyNumber" placeholder="{{ trans('misc.campaign_funds') }}">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
