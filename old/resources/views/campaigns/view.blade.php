...
<div class="col-md-7 margin-bottom-20">
	...
	<div class="text-center mb-2 position-relative company_gallery">
...
<div class="container company_gallery_thumb">
    <ul class="slick-thumb">
			<li class="active">
			<?php 
				$src=$response->large_image;
				print '<img class="img-slick" src="../../public/campaigns/large/'.$src.'"   title="img" alt="img" height="100px"/>';
			?>
			</li>
		@foreach ($imgs as $img)
			<li>
			<?php
				print '<img class="img-slick" src="../../public/imgs/'.$response->id.'/'.$img.'"  title="img" alt="img" height="100px"/>';
			?>
			</li>
		@endforeach
    </ul>
...
<!-- Start Panel -->
	...
	<small class="btn-block margin-bottom-10 text-muted">
		<strong class="text-strong-small">{{ App\Helper::amountFormat($response->funds) }}</strong> {{trans('misc.raised_of')}} {{ App\Helper::amountFormat($response->goal)}} {{strtolower(trans('misc.goal')) }}
